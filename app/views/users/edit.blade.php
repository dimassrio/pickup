	...
	<div class="page-wrapper">
		...
		<div class="row">
			<div class="large-8 columns large-offset-2 columns">
					{{Form::open(array('url'=>url('administrator/users'.'/'.$user->id), 'method'=>'put'))}}
						<div class="row">
							<div class="large-3 columns">
								<label for="realname" class="right">Nama Asli</label>
							</div>
							<div class="large-9 columns">
								<input type="text" id="realname" name="realname" placeholder="{{$user->realname}}">
							</div>
						</div>
						<div class="row">
							<div class="large-3 columns">
						...
						<div class="row">
							...
							<div class="large-9 columns">
								<input type="text" id="birthdate" name="birthdate" placeholder="{{$user->birthdate}}">
							</div>
						</div>
						<div class="row section">
